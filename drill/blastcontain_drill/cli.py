...
@click.option("--mcp-poisoning", "enable_mcp_poisoning", is_flag=True, default=False, help="Add controlled MCP description/response poisoning scenarios")
...
def main(
    ...
    enable_multiturn, enable_mcp_poisoning,
    ...
    cfg = load_config(
        ...
        cli_overrides={
            ...
            "enable_mcp_poisoning": enable_mcp_poisoning if enable_mcp_poisoning else None,
